...
namespace s3d
{
	namespace detail
	{
		static GLuint LoadShaders(const FilePath& vsFilePath, const FilePath& psFilePath)
		{
			...
			LOG_TRACE(U"vertexShader");
			//LOG_TRACE(U"VS: {0}"_fmt(Unicode::Widen(vsSource)));
			...
			LOG_TRACE(U"pixelShader");
			//LOG_TRACE(U"PS: {0}"_fmt(Unicode::Widen(psSource)));
